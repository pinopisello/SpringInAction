        ...
        try {
            if ( PolicyTypeUtil.derivedTokenKeyBinding(keyBinding)) {
                ...
                if (PolicyTypeUtil.x509CertificateBinding(originalKeyBinding)) {
                    ...
                    boolean includeIST = (ikb.INCLUDE_ALWAYS_TO_RECIPIENT.
                            equals(ikb.getIncludeToken()) || ikb.INCLUDE_ALWAYS.
                            equals(ikb.getIncludeToken()));
                ...
                boolean includeIST = (ikb.INCLUDE_ALWAYS_TO_RECIPIENT.
                        equals(ikb.getIncludeToken()) || ikb.INCLUDE_ALWAYS.equals(ikb.getIncludeToken()));
