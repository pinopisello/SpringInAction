...
/**
 * StageGroupMaster generated by hbm2java
 */
@Entity
@Table(name="STAGE_GROUP_MASTER"
    ,schema="DORIS"
)
public class StageGroupMaster extends Base.BaseEntity implements java.io.Serializable {


     private StageGroupMasterId id;
     ...
     private Character prorationMethod;
     ...
     private String ptdUseReasonCde;
     ...
     private String groupTransactionType;
     private Integer seqGroupId;

    public StageGroupMaster() {
    }

	
    public StageGroupMaster(StageGroupMasterId id) {
        this.id = id;
    }
    public StageGroupMaster(StageGroupMasterId id, String transactionStatus, String groupId, String shortName, Character levelCode, String parentGroupId, String groupName1, String groupName2, Character groupType, String sicCode, Character prorationMethod, Character billingLevel, String billingCycle, String billingBatch, Byte noOfRetroMonths, Date billedThroughDate, Short gracePeriod, Character sortOption, Date nextOpenStartDt, Date nextOpenEndDate, String holdReason, Date holdDate, Date paidThroughDate, Character billingFrequency, Date commonBillingDate, Short paymentDueDaysAfter, Character rateFreezeCalc, String invoicePrintFormat, Character useEftFlg, BigDecimal adultDepAgeParam, Short maxDependentsCharge, Character calcDueDateRule, Byte calcDueDateDays, String ptdUseReasonCde, Short ptdThresholdPct, String nationalEmployerId, String taxId, String comments, String allowBypassEdit, String accountType, String paplessSrcIdentifier, String contractYrTimeFrame, String billingFormat, String asoIndicator, Character securityCode, Date insertDatetime, String insertUser, String insertProcess, Date updateDatetime, String updateUser, String updateProcess, String userDefined1, String userDefined2, String userDefined3, String userDefined4, String userDefined5, String userDefined6, String userDefined7, String userDefined8, String userDefined9, String userDefined10, String userDefined11, String userDefined12, String userDefined13, String userDefined14, String userDefined15, String userDefined16, String userDefined17, String userDefined18, String userDefined19, String userDefined20, String userDefined21, String userDefined22, String userDefined23, String userDefined24, Date userDate1, Date userDate2, Date userDate3, Date userDate4, Date userDate5, Date userDate6, Date userDate7, Date userDate8, Date userDate9, Date userDate10, Date userDate11, Date userDate12, Date userDate13, Date userDate14, Date userDate15, Date userDate16, Date userDate17, Date userDate18, Date userDate19, Date userDate20, Date userDate21, Date userDate22, String groupTransactionType, Integer seqGroupId) {
       this.id = id;
       ...
       this.ptdUseReasonCde = ptdUseReasonCde;
       ...
       this.groupTransactionType = groupTransactionType;
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="transactionId", column=@Column(name="TRANSACTION_ID", nullable=false, precision=22, scale=0) ) } )
    public StageGroupMasterId getId() {
        return this.id;
    }
    
    public void setId(StageGroupMasterId id) {
        this.id = id;
    }
    ...
    public Character getLevelCode() {
        return this.levelCode;
    }
    
    public void setLevelCode(Character levelCode) {
        this.levelCode = levelCode;
    }
    
    @Column(name="PARENT_GROUP_ID", length=12)
    ...
    @Column(name="PRORATION_METHOD", length=1)
    public Character getProrationMethod() {
        return this.prorationMethod;
    }
    
    public void setProrationMethod(Character prorationMethod) {
        this.prorationMethod = prorationMethod;
    }
    ...
    @Column(name="HOLD_REASON", length=5)
    ...
    @Column(name="PTD_USE_REASON_CDE", length=5)
    public String getPtdUseReasonCde() {
        return this.ptdUseReasonCde;
    }
    
    public void setPtdUseReasonCde(String ptdUseReasonCde) {
        this.ptdUseReasonCde = ptdUseReasonCde;
    }
    ...
    @Column(name="GROUP_TRANSACTION_TYPE", length=1)
    public String getGroupTransactionType() {
        return this.groupTransactionType;
    }
    
    public void setGroupTransactionType(String groupTransactionType) {
        this.groupTransactionType = groupTransactionType;
    }
    
    @Column(name="SEQ_GROUP_ID", precision=9, scale=0)
    public Integer getSeqGroupId() {
        return this.seqGroupId;
    }
    
    public void setSeqGroupId(Integer seqGroupId) {
        this.seqGroupId = seqGroupId;
    }
