...
/**
 * StageBenefPackageMstr generated by hbm2java
 */
@Entity
@Table(name="STAGE_BENEF_PACKAGE_MSTR"
    ,schema="DORIS"
)
public class StageBenefPackageMstr extends Base.BaseEntity implements java.io.Serializable {


     private StageBenefPackageMstrId id;
    ...
    public StageBenefPackageMstr() {
    }

	
    public StageBenefPackageMstr(StageBenefPackageMstrId id) {
        this.id = id;
    }
    public StageBenefPackageMstr(StageBenefPackageMstrId id, String requestType, String benefitPackageId, String shortDescription, String narrative, Short subPeNotCovDays, Short subPeConditnDays, Short depPeNotCovDays, Short depPeConditnDays, Character securityCode, Date insertDatetime, String insertUser, String insertProcess, Date updateDatetime, String updateUser, String updateProcess, String processingOrderId, Character applyPatlibTo, Character patientLiability, BigDecimal patlibPercent, Date userDate1, Date userDate2, Date userDate3, Date userDate4, Date userDate5, Date userDate6, Date userDate7, Date userDate8, Date userDate9, Date userDate10, Date userDate11, Date userDate12, Date userDate13, Date userDate14, Date userDate15, Date userDate16, Date userDate17, Date userDate18, Date userDate19, Date userDate20, String userDefined1, String userDefined2, String userDefined3, String userDefined4, String userDefined5, String userDefined6, String userDefined7, String userDefined8, String userDefined9, String userDefined10, String userDefined11, String userDefined12, String userDefined13, String userDefined14, String userDefined15, String userDefined16, String userDefined17, String userDefined18, String userDefined19, String userDefined20, String packageType, String albenId, String patientLiabComparison, String patientLiabType1, String patientLiabType2, String altSchedId, String altRegionId, Character modifSearchOrder, String mappingString, String transactionStatus) {
       this.id = id;
    ...
    public StageBenefPackageMstrId getId() {
        return this.id;
    }
    
    public void setId(StageBenefPackageMstrId id) {
        this.id = id;
    }
    ...
    @Column(name="SHORT_DESCRIPTION", length=15)
    ...
    @Column(name="PROCESSING_ORDER_ID", length=2)
