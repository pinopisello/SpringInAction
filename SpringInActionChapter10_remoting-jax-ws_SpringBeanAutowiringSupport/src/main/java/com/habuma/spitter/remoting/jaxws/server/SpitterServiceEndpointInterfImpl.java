...
public class SpitterServiceEndpointInterfImpl extends SpringBeanAutowiringSupport  {
    private static final Logger LOG = Logger.getLogger(SpitterServiceEndpointInterfImpl.class.getName());
    
    @Autowired
    private com.habuma.spitter.remoting.jaxws.SEI.SpitterService spitterService;
    ...
    public com.habuma.spitter.remoting.jaxws.server.Spitter getSpitterById(long arg0) { 
        ...
        spitterService.getSpitterById(arg0);
        try {
