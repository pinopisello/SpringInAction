...
public class SpitterService extends Service {
    ...
    public final static QName SERVICE = new QName("http://SEI.jaxws.remoting.spitter.habuma.com/", "SpitterService");
    public final static QName SpitterServiceEndpointPort = new QName("http://SEI.jaxws.remoting.spitter.habuma.com/", "SpitterServiceEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public SpitterServiceEndpoint getSpitterServiceEndpointPort() {
        return super.getPort(SpitterServiceEndpointPort, SpitterServiceEndpoint.class);
    }
    ...
    public SpitterServiceEndpoint getSpitterServiceEndpointPort(WebServiceFeature... features) {
        return super.getPort(SpitterServiceEndpointPort, SpitterServiceEndpoint.class, features);
    }
