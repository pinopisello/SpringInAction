...
public class SpitterService extends Service {
    ...
    public final static QName SERVICE = new QName("http://pippo/SpitterService", "SpitterService");
    public final static QName SpitterServiceEndpointPort = new QName("http://pippo/SpitterService", "SpitterServiceEndpointPort");
    static {
        URL url = null;
        try {
