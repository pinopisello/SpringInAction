...
public class ObjectFactory {
    ...
    private final static QName _AddSpittleResponse_QNAME = new QName("http://SEI.jaxws.remoting.spitter.habuma.com/SpitterService", "addSpittleResponse");
    private final static QName _AddSpittle_QNAME = new QName("http://SEI.jaxws.remoting.spitter.habuma.com/SpitterService", "addSpittle");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SEI.jaxws.remoting.spitter.habuma.com/SpitterService", name = "addSpittleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SEI.jaxws.remoting.spitter.habuma.com/SpitterService", name = "addSpittle")
